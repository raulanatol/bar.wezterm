...
local function get_require_path()
  local path = "httpssCssZssZsgithubsDscomsZsraulanatolsZsbarsDswezterm"
  local path_trailing_slash = "httpssCssZssZsgithubsDscomsZsraulanatolsZsbarsDsweztermsZs"
